...
def wish_me():
    ...
    speak("I am Archimedis your voice Assistant. How can I help you today?")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if query == "none":
            ...
            speak("I am Archimedis a voice assistant! let me know how can i help you?")
        elif 'time' in query:
            tell_time()
        elif 'date' in query:
            tell_date()
            ...
            search_web(query)
        elif 'exit' in query or 'quit' in query or 'bye' in query or 'thanks'in query or 'goodbye' in query:
